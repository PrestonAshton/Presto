...
static LRESULT CALLBACK PrestoDX9WindowCallback(HWND windowHandle, UINT message,
...
void OpenDX9GameWindow() 
{
	...
	windowClass.lpfnWndProc = PrestoDX9WindowCallback;
	...
	d3d9Globals.presentationParams.MultiSampleType = D3DMULTISAMPLE_NONE; // antialiasing TODO(Preston): CONFIG ME!
