...
#include <Presto/Math/Vector3.h>
#include <Presto/Math/Vector4.h>
...
// NOTE(Preston): Colour32 can be cast to a Colour24 if we don't need the alpha when we normalise. \
